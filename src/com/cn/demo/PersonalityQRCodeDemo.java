...
public class PersonalityQRCodeDemo {
	...
	public void createQrcode(String content, String imgType, 
		...
		try {
			...
			//获取图片大小		
			int width=logo.getWidth()/2;
			int height=logo.getHeight()/2;
			//填充起始位置
	...
	public static void main(String[] args) {
		...
		int pixel = 5;//模块像素值
		String imgPath = "E:/PersonalityQRCodeDemo.png";
		//实现个性化二维码
		PersonalityQRCodeDemo demo =new PersonalityQRCodeDemo();
